...
public class Practice05Controller {
	...
	*/
	...
	/*
	//1) 경로별 각자 페이지를 사용하는 케이스
	@GetMapping("/pathA")
	public String pathA() {
		return "practice05/pathA";
	}
	
	@GetMapping("/pathB")
	public String pathB() {
		return "practice05/pathB";
	}
	
	@GetMapping("/pathCommon/A")
	public String pathCommonA() {
		return "practice05/pathCommon/A";
	}
	
	@GetMapping("/pathCommon/B")
	public String pathCommonB() {
		return "practice05/pathCommon/B";
	}
	*/
	...
	*/
	...
	public String pathCommonA(Model model) {
		...
		return "practice05/pathCommon/common";
	}
	...
	public String pathCommonA(@PathVariable String producName,Model model) {
